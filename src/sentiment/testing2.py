...
class SentimentClassifier:
    ...
    def load_data(self):
        ...
        self.df = self.df[~self.df.messageTextEnglish.isnull()]
    ...
    def inference(self):
        ...
        self.df['sentiment_name_twitter_xlm_roberta_base_sentiment'] = self.df['messageTextEnglish'].progress_apply(lambda x: self.base_sentiment(x))
        print("Inference Base Emotion Model")        
        self.df['sentiment_name_twitter_roberta_base_emotion'] = self.df['messageTextEnglish'].progress_apply(lambda x: self.base_emotion(x))
