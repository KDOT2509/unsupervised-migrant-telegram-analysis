...
class SentimentClassifier:
    ...
    def sentiment_classifier(self, text: str) -> str:
    ...
    def inference(self):
        self.df['sentiment_name_twitter_xlm_roberta_base_sentiment'] = self.df['messageTextEnglish'].progress_apply(lambda x: self.sentiment_classifier(x))
